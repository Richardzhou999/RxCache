...
import com.github.richard.core.EvictDynamicKeyGroup;
import com.github.richard.core.Reply;
import com.github.richard.core.RxCacheException;
...
public final class ProcessorProvidersBehaviour implements ProcessorProviders {
  ...
  @Override public Observable<Void> evictAll() {
    return Observable.defer(new Supplier<ObservableSource<? extends Void>>() {
      @Override
      public ObservableSource<? extends Void> get() throws Throwable {
