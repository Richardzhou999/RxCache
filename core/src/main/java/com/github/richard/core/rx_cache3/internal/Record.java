...
package com.github.richard.core.rx_cache3.internal;
  ...
  public Record(T data, Boolean expirable, Long lifeTime) {
    ...
    if (isList) {
      ...
      if (map.size() > 0) {
        ...
        final Iterator<Entry> iterator = ((Set<Entry>) map.entrySet()).iterator();
        ...
        while (iterator.hasNext() || valueClass == null && keyClass == null) {
          ...
          if (keyClass != null && keyClass != next.getKey().getClass()) {
            keyClass = null;
          }
          if (valueClass != null && valueClass != next.getValue().getClass()) {
            valueClass = null;
          }
        }
