...
public final class RxCache3 {
  private final Builder builder;
  private ProxyProviders proxyProviders;

  private RxCache3(Builder builder) {
  ...
  public static class Builder {
     ...
     */
    public RxCache3 persistence(File cacheDirectory, JolyglotGenerics jolyglot) {
      if (cacheDirectory == null) {
        throw new InvalidParameterException(com.github.richard.core.rx_cache3.internal.Locale.REPOSITORY_DISK_ADAPTER_CAN_NOT_BE_NULL);
      }
      if (!cacheDirectory.exists()) {
        throw new InvalidParameterException(com.github.richard.core.rx_cache3.internal.Locale.REPOSITORY_DISK_ADAPTER_DOES_NOT_EXIST);
      }
      if (!cacheDirectory.canWrite()) {
        throw new InvalidParameterException(com.github.richard.core.rx_cache3.internal.Locale.REPOSITORY_DISK_ADAPTER_IS_NOT_WRITABLE);
      }

      if (jolyglot == null) {
        throw new InvalidParameterException(com.github.richard.core.rx_cache3.internal.Locale.JSON_CONVERTER_CAN_NOT_BE_NULL);
      }

      this.cacheDirectory = cacheDirectory;
      this.jolyglot = jolyglot;

      return new RxCache3(this);
    }
